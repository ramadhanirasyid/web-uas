        ...
        <div class="row justify-content-center">
            <div class="p-5 bg-light rounded-3 col-xl-4 border">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        <label for="age" class="form-label">Layanan</label>
                        <h5>{{ $employee->position->name }}</h5>
                    </div>
                    <div class="col-md-12 mb-3">
                        <label for="age" class="form-label">Informasi Detail Perusahaan</label>
                        @if ($employee->original_filename)
                            ...
                            <a href="{{ route('employees.downloadFile', ['employeeId' => $employee->id]) }}" class="btn btn-primary btn-sm mt-2">
                                <i class="bi bi-download me-1"></i> Download Detail Informasi Perusahaan
                            </a>
                        @else
                            <h5>Tidak ada</h5>
                        @endif
